...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Todo.tasks":
		...
		return e.complexity.Todo.Tasks(childComplexity), true
...
func (ec *executionContext) _Todo_tasks(ctx context.Context, field graphql.CollectedField, obj *model.Todo) (ret graphql.Marshaler) {
...
func (ec *executionContext) fieldContext_Todo_tasks(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Todo",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _Todo(ctx context.Context, sel ast.SelectionSet, obj *model.Todo) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "tasks":
			out.Values[i] = ec._Todo_tasks(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		default:
